...
public class HairColorsSkinButtonsController : MonoBehaviour
{
    ...
    [SerializeField]
    private HairColorSkinCard[] skinCards;
    ...
    private SkinCard clickedSkinCard;
    private SoundController soundController;

    private void OnEnable()
    {
        HairColorSkinCard.HairColorCardClicked += OnSkinCardClicked;
    ...
    void Initialization()
    {
        ...
        {
            skinCards[i].ChangeImageColor(hairColors[i]);
        }

    }
    void Start()
    {
        hairColors = skinsColorsStorage.GetColorsArray();
        Initialization();
    ...
    {
        skinsColorsStorage.ShowSkinObject(id);
    }
