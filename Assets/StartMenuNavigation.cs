...
public class StartMenuNavigation : MonoBehaviour
{
    ...
    [Header("Open Buttons")]
    [SerializeField]
    private Button openLevelChooseButton;
    [SerializeField]
    ...
    [SerializeField]
    private Canvas shopPlayerModelCanvas;
    ...
    void ResetAllCanvas()
    {
        ...
        ToggleCanvas(shopPlayerModelCanvas, false);
    }
    ...
    public void ToggleSkinShop(bool toggle)
    {
        ...
        ToggleCanvas(startCanvas, !toggle);
        ToggleCanvas(shopPlayerModelCanvas, toggle);
        soundController.MakeClickSound();
    }
